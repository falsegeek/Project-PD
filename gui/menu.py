...
class Ui_menu(object):
    def setupUi(self, menu):
        ...
        self.push_txt.setGeometry(QtCore.QRect(150, 50, 75, 31))
        font = QtGui.QFont()
        ...
        self.push_wav.setGeometry(QtCore.QRect(260, 50, 75, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.push_Word = QtWidgets.QPushButton(self.group_choose)
        self.push_Word.setGeometry(QtCore.QRect(40, 50, 75, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.push_Word.setFont(font)
        self.push_Word.setObjectName("push_Word")
        self.push_bmp = QtWidgets.QPushButton(self.group_choose)
        self.push_bmp.setGeometry(QtCore.QRect(200, 100, 75, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.push_jpg.setGeometry(QtCore.QRect(90, 100, 75, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.push_Word.clicked.connect(self.word_screen) #переход на окно шифрования Word
    ...
    def word_screen(self): #переход на окно шифрования Word
