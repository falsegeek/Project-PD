...
class Ui_bmp_screen(object):
    ...
    # группа где находятся все элементы шифрования
        ...
        self.bmp_img.setGeometry(QtCore.QRect(280, 50, 81, 91))
    ...
    def retranslateUi(self, bmp_screen):
        ...
        self.description_enc1.setText(_translate("bmp_screen", "1. Выберите данные для шифрования в формате \"txt\""))
        self.push_enc.setText(_translate("bmp_screen", "Файл"))
        self.description_enc2.setText(_translate("bmp_screen", "2. Выберите степень сжатия"))
        ...
        self.description_dec.setText(_translate("bmp_screen", "1. Выберите файл для расшифровки"))
        self.push_dec.setText(_translate("bmp_screen", "Файл"))
